...
<div class="span9 well">
	...
	<form class="form-horizontal" action="<?php echo router_url($class, $method); ?>" method="post" name="formbackend">
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="jobname" name="jobname" placeholder="进程名称" value="<?php if (isset($form)) echo $form['jobname']; ?>">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="checkbox" id="writelog" name="writelog" value="1"/> 
			</div>
		</div>
		...
		<div class="control-group">
			<div class="controls">
				<button type="submit" class="btn" value="1" name="submit_form">添加</button>
